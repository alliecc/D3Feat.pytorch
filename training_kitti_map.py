...
from datasets.mapdatasets import KITTIMapDataset#ThreeDMatchDataset, ThreeDMatchTestset
...
if __name__ == '__main__':
    ...
    shutil.copy2(os.path.join('datasets', 'mapdatasets.py'), os.path.join(config.snapshot_dir, 'dataset.py'))
    json.dump(
        config.__dict__,
